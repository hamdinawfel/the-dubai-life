<div class="bg-black flex items-center">
  ...
  <!-- Phone Navbar -->
  <ul class="relative w-full flex md:hidden items-center justify-center space-x-8 px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    <li>
      <a href="/" aria-label="The_dubai_life" title="The_dubai_life" class="inline-flex items-center">
      <img class='h-16'src='../../assets/The_dubai_life_logo.png' alt='The dubai life' />
    </a>
    <li x-data="{ open: false }">
      <button @click="open = true" aria-label="Open Menu" title="Open Menu" class="lg:hidden p-2 float-left transition duration-200 rounded focus:outline-none focus:shadow-outline">
        ...
        <div x-show="false" class="z-90 absolute top-0 left-0 w-full ">
